<%@page import="entidades.Facilitador"%>
									...
									<div class="col-sm-12">
										<div class="card-box table-responsive">
											...
											<table id="datatable-buttons"
												...
												<%
												ArrayList<Facilitador> listaFacilitador = new ArrayList<Facilitador>();
												Dt_Facilitador dtu = new Dt_Facilitador();
												listaFacilitador = dtu.listaFaciActivos();
												%>
												<thead>
													<tr>
														<th>Correo</th>
												...
												<tbody>
												<%
												for (Facilitador tFaci : listaFacilitador) {
													String estado = "";
													
												%>
													
													<tr>
														<td><%=tFaci.getEmail() %></td>
														<td><%=tFaci.getGrado_academico() %></td>
														<td><%=tFaci.getId_uca() %></td>
														<td><%=tFaci.getNombre_completo() %></td>
														<td><%=tFaci.getTelefono_contacto() %></td>
