                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                     <%
                      ...
                      //	Dt_inscripcion dti = new Dt_inscripcion();
                      	//listaInscripcion = dti.listaInActivos();
                      	
                    	ArrayList<Vw_Inscripcion> lista = new ArrayList<Vw_Inscripcion>();
                      	Dt_inscripcion dtur = new Dt_inscripcion();
                      	lista = dtur.listaInActivos2();
	                  %>
                      <thead>
                        <tr>
                      ...
                      <tbody>
                      <%
                      	for(Vw_Inscripcion tu : lista){
                      		
                      %>
                        <tr>
                         
                          <td><%=tu.getAno_inscripcion() %></td>
                          <td><%=tu.getNombre_real() %></td>
                          <td><%=tu.getNombre_carrera() %></td>
                          <td><%=tu.getNombre_departamento() %></td>
                          <td><%=tu.getNombre_facultad() %></td>
                          <td><%=tu.getNombre_oferta() %></td>
                          <td><%=tu.getDescripcion()%></td>  
                             <td><%=tu.getNombre() %></td>                            
                             <td><%=tu.getNombre_modalidad()%></td>
                             <td><%=tu.getNombre_completo()%></td>
                                               
                           <td><a href="frm_modInscripcion.jsp" target="blank"><i class="fa fa-2x fa-edit" title="Editar Facultad"></i></a> 
							<a href="frm_vwInscripcion.jsp" target="blank"><i class="fa fa-eye fa-2x" title="Visualizar Facultad"></i></a> 
							<a href="frm_delInscripcion.jsp" target="blank"><i class="fa fa-2x fa-trash" title="Eliminar Facultad"></i></a></td>
                        </tr>
                        <% 
                      	}
                        %>
