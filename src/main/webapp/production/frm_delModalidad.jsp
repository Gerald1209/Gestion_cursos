...
<head>
    ...
    <title>Gestión de Cursos | Tipos de Capacitación</title>
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Eliminar Tipo de Capacitación existente </h2>
...
<!--                                         <span class="section">Personal Info</span> -->
										<div class="field item form-group">
                                         ...
                                         <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Estilo: <span class="required"></span></label>
                                            <div class="col-md-6 col-sm-6">
                                            	<input class="form-control" data-validate-length-range="6" data-validate-words="2" name="estilo" placeholder="" readonly />
