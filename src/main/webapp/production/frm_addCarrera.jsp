                            ...
                            <ul class="nav side-menu">
                              <li><a><i class="fa fa-shield"></i> Seguridad <span
									...
									<ul class="nav child_menu">
										...
										<li><a href="tbl_opcion.jsp.jsp">Opciones</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <form class="" action="../Sl_Carrera" method="post" novalidate>
...
<!--                                         <span class="section">Personal Info</span> -->
 										...
 										<div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input class="form-control"  id="nombre" name="nombre" placeholder="nombre de la carrera" required="required" />
...
<!--                                            <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="ex. John f. Kennedy" required="required" /> -->
												<%
							                      	...
							                      	Dt_Departamento dtu = new Dt_Departamento();
							                     	listaDepartamento = dtu.listaDepActivos();
								                 %>
												<select class="form-control js-example-basic-single" name="cbxDep" id="cbxDep" required="required">
												  ...
												  <% 
												  	for(Departamento tu :listaDepartamento){
												  %>
												 <option value="<%=tu.getId_departamento()%>"><%=tu.getNombre_departamento() %></option> 
												  <%
												  	}
												  %>
												</select>
                                        ...
                                        <div class="ln_solid">
                                            <div class="form-group">
                                                <div class="col-md-6 offset-md-3">
                                                    ...
                                                    <a href="tbl_carrera.jsp" type='reset' class="btn btn-success">Regresar</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
