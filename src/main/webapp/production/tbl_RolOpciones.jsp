...
<html>
  <head>
    ...
    <title>Gestión | Opciones asignadas a roles</title>
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Gestión de cursos de formación docente</span></a>
            </div>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Gestion de Opciones asignadas a roles</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Registro a Opciones asignadas a roles</h2>
                      ...
                      <div class="row">
                          <div class="col-sm-12">
                            ...
                            <div class="text-muted font-13 col-md-12" style="text-align: right;">
                            	<a href="frm_addRolOpciones.jsp">
                            		<i class="fa fa-2x fa-plus-square" title="Nuevas Opciones asignadas a roles"></i>
                            	</a>
                            	<br></br>
                            </div>
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      <%
                      	ArrayList<OpcionRol> listaOpcionRol = new ArrayList<OpcionRol>();
                      	Dt_OpcionRol dor = new Dt_OpcionRol();
                      	listaOpcionRol = dor.listaOpcRolActivos();
	                  %>
                      <thead>
                        <tr>
                          <th>Rol</th>
