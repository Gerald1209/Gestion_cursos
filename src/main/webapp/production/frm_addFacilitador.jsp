			...
			<div class="right_col" role="main">
				<div class="">
					...
					<div class="col-md-12 col-sm-12 ">
						<div class="x_panel">
                                <div class="x_title">
                                    <h2>Ingrese un Nuevo Facilitador </h2>
...
<!--                                         <span class="section">Personal Info</span> -->
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Grado académico<span class="required">*</span></label>
                                            <div class="col-md-6 col-sm-6">
                                            	<input class="form-control"  name="academic" placeholder="Primer Semestre 2020"  />
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input class="form-control"  name="iduca" placeholder="Primer Semestre 2020"  />
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                            	<input class="form-control"  name="fullname" placeholder="Primer Semestre 2020"  />
                                        ...
                                        <div class="ln_solid">
                                            <div class="form-group">
                                                <div class="col-md-6 offset-md-3">
                                                    ...
                                                    <a href="tbl_facilitador.jsp" class="btn btn-success">Regresar</a>
                                                </div>
                                            </div>
                                        </div>
                                </div>
