...
<title>Gestión | Roles asignados a usuarios</title>
						...
						<div class="menu_section">
							<ul class="nav side-menu">
								<li><a><i class="fa fa-shield"></i> Seguridad <span
									...
									<ul class="nav child_menu">
										...
										<li><a href="tbl_UsuarioRol.jsp">Asignar roles a
												usuario</a></li>
										<li><a href="tbl_RolOpciones.jsp">Asignar opciones a
												los roles</a></li>
									</ul></li>
								...
								<li><a><i class="fa fa-archive"></i> Inscripcion <span
									...
									<ul class="nav child_menu">
										<li><a href="tbl_inscripcion.jsp">Gestion de
												Inscripciones</a></li>
										<li><a href="frm_addInscripcion.jsp">Inscripcion
												Docente</a></li>
									</ul></li>
								...
								<li><a><i class="fa fa-clone"></i>Evaluacion <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="tbl_EscalaCalificacion.jsp">Escalas de
												Evaluacion</a></li>
					...
					<nav class="nav navbar-nav">
						<ul class=" navbar-right">
							<li><a data-toggle="tooltip" data-placement="top"
								title="Cerrar Sesión" href="login.html"> <span
									class="glyphicon glyphicon-off fa-2x" aria-hidden="true"></span>
							</a></li>
				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3>Roles asignados a usuarios</h3>
						</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								<div class="x_title">
									<h2>Registro de roles asignados a usuarios</h2>
										...
										<div class="col-sm-12">
											<div class="card-box table-responsive">
												<div class="text-muted font-13 col-md-12"
													...
													<a href="frm_addUsuarioRol.jsp"> <i
														class="fa fa-2x fa-plus-square"></i>
												...
												<table id="datatable-buttons"
													...
													style="width: 100%">
													<%
                      									ArrayList<Vw_userrol> listaUR = new ArrayList<Vw_userrol>();
              								        	Dt_userrol dtur = new Dt_userrol();
              								        	listaUR = dtur.listarUserRol();
	                  								%>
													...
													<tbody>
														...
														<tr>
															...
															<td><a href="frm_modUsuarioRol.jsp" target="blank"><i
																	class="fa fa-2x fa-edit" title="Editar Gastos"></i></a> <a
																href="frm_vwUsuarioRol.jsp" target="blank"><i
																	class="fa fa-eye fa-2x" title="Visualizar gasto"></i></a> <a
																href="frm_delUsuarioRol.jsp" target="blank"><i
																	class="fa fa-2x fa-trash" title="Eliminar Gasto"></i></a></td>
														</tr>
														<%
														}
														%>
