...
<head>
    ...
    <title>Gestión de Cursos| Evaluaciones </title>
                        ...
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                               <li><a><i class="fa fa-shield"></i> Seguridad <span
								...
								<li><a><i class="fa fa-archive"></i> Evaluacion <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="tbl_Evaluacion.jsp">Gestion de Evaluaciones</a></li>
										<li><a href="frm_addEvaluacion.jsp">Evaluacion Docente</a></li>
									</ul>
								</li>
...
<!--                                                 <input class="form-control" class='optional' name="occupation" data-validate-length-range="5,15" type="text" /></div> -->
												<%
								                 ...
								                 %>
								                 <select class="form-control" name="cbxUsuario" id="cbxUsuario" disabled>
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Carrera: </label>
                                            <div class="col-md-6 col-sm-6">
<!--                                            <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="ex. John f. Kennedy" required="required" /> -->
												<%
								                 ...
								                 %>
												<select class="form-control" name="cbxCarrera" id="cbxCarrera" disabled>
												  <option value="">Seleccione...</option>
											  <% 
...
<!--                                                 <input class="form-control" class='optional' name="occupation" data-validate-length-range="5,15" type="text" /></div> -->
												<%
								                 ...
								                 %>
								                 <select class="form-control" name="cbxDepartamento" id="cbxDepartamento" disabled>
												  <option value="">Seleccione...</option>
												  <% 
...
<!--                                                 <input class="form-control" class='optional' name="occupation" data-validate-length-range="5,15" type="text" /></div> -->
												<%
								                 ...
								                 %>
								                 <select class="form-control" name="cbxFacultad" id="cbxFacultad" disabled>
												  <option value="">Seleccione...</option>
												  <% 
                                         ...
                                         <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Oferta: </label>
                                            <div class="col-md-6 col-sm-6">
<!--                                                 <input class="form-control" class='optional' name="occupation" data-validate-length-range="5,15" type="text" /></div> -->
												<%
								                 ...
								                 %>
								                 <select class="form-control" name="cbxOfertaDetalle" id="cbxOfertaDetalle" disabled>
												  <option value="">Seleccione...</option>
												  <% 
												  	for(Oferta_Detalle trol :listaOferta){
												  %>
												  <option value="<%=trol.getId_oferta_detalle()%>"><%=trol.getCapacitacion()%>-- <%=trol.getFecha_inicial() %></option>
												  <%
												  	}
												  %>
                                        ...
                                        <div class="field item form-group">
                                            <label class="col-form-label col-md-3 col-sm-3  label-align">Evaluacion: <span class="required"></span></label>
                                            <div class="col-md-6 col-sm-6">
<!--                                                 <input class="form-control" class='optional' name="occupation" data-validate-length-range="5,15" type="text" /></div> -->
												<%
							                      	ArrayList<EscalaCalificacion> listaEC = new ArrayList<EscalaCalificacion>();
							                      	Dt_EscalaCalificacion des = new Dt_EscalaCalificacion();
							                      	listaEC = des.listaEscActivos();
								                 %>
								                 <select class="form-control js-example-basic-single" name="cbxOfertaDetalle" id="cbxOfertaDetalle" required="required">
												  <option value="">Seleccione...</option>
												  <% 
												  	for(EscalaCalificacion esc :listaEC){
												  %>
												  <option value="<%=esc.getId_escala()%>"><%=esc.getDescripcion()%></option>
												  <%
												  	}
												  %>
                                        ...
                                        <div class="ln_solid">
                                            <div class="form-group">
                                                <div class="col-md-6 offset-md-3">
                                                    ...
                                                    <a href="tbl_inscripcion.jsp" class="btn btn-success">Regresar</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
