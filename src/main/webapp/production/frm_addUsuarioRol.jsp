                ...
                <div class="">
                    <div class="page-title">
                        <div class="title_left">
                            <h3>Agregar nuevo UsuarioRol</h3>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Ingresar nuevo UsuarioRol </h2>
                                    
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <form class="" action="../Sl_gestionUserRol" method="post" novalidate>
...
<!--                                         <span class="section">Personal Info</span> -->
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
												...
												%>
                                            	<select id="usuario" name="usuario" class="form-control js-example-basic-single">
													<option value="">...Seleccione</option>
													<%for(Usuario us: listaUs){ %>
													<option value="<%=us.getId_usuario() %>"><%=us.getNombre_real() %></option>
													<%} %>
												</select>
										...
										<div class="field item form-group">
											<label class="col-form-label col-md-3 col-sm-3  label-align">Asignar
										...
										<div class="ln_solid">
                                            <div class="form-group">
                                                <div class="col-md-6 offset-md-3">
                                                    ...
                                                    <a href="tbl_UsuarioRol.jsp" class="btn btn-success">Regresar</a>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
