...
<title>Gestion de Cursos | Reporte Certificado</title>
									...
									<div class="col-sm-12">
										<div class="card-box table-responsive">
											...
											<table id="datatable-buttons"
												...
												style="width: 100%">
												<%
												Rpt_Certificadas rc = new Rpt_Certificadas();
												Dt_Reportes drc = new Dt_Reportes();
												ArrayList<Rpt_Certificadas> listaRpt = new ArrayList<Rpt_Certificadas>();
												// CONSTRUIMOS EL OBJETO CON LOS VALORES DE LOS CONTROLES
												
												rc.setAno_inscripcion(request.getParameter("year"));
												rc.setPeriodo(request.getParameter("periodo"));
												rc.setSexo(Integer.parseInt(request.getParameter("sexo")));
												rc.setId_facultad(Integer.parseInt(request.getParameter("facultad")));
												rc.setId_departamento(Integer.parseInt(request.getParameter("depto")));
												rc.setId_carrera(Integer.parseInt(request.getParameter("carrera")));
												
												
												
												
												listaRpt = drc.reporteCertificados(rc);
												%>
												<thead>
													<tr>
												...
												<tbody>
													<%
													for (Rpt_Certificadas rpt : listaRpt) {
													...
													<tr>
														...
														<td><%=rpt.getCapacitacion() %> -- <%=rpt.getNombre_modalidad() %></td>
													</tr>
													<%
													}
													%>
